...
public class TambahSiswaActivity extends AppCompatActivity {
    ...
    int id_kelas;
    String namaSiswa, asal, umur, jenis_kelamin, email, nomor_hp;
    boolean empty;
    ...
    private void saveData() {
        ...
        siswaModel.setNomor_hp(nomor_hp);
    ...
    private void cekData() {
        ...
        nomor_hp = edtPhone.getText().toString();

        empty = namaSiswa.isEmpty() || asal.isEmpty() || umur.isEmpty() || email.isEmpty() || jenis_kelamin.isEmpty() || nomor_hp.isEmpty();
    }
