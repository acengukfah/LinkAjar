  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(2) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        ...
        _db.execSQL("CREATE TABLE IF NOT EXISTS `tb_siswa` (`id_siswa` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `id_kelas` INTEGER NOT NULL, `nama_siswa` TEXT, `umur` TEXT, `jenis_kelamin` TEXT, `asal` TEXT, `nomor_hp` TEXT, `email` TEXT)");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \"45d9ad07c85cac1beb9aebc815082ad3\")");
      }
      ...
      protected void validateMigration(SupportSQLiteDatabase _db) {
        ...
        if (! _infoKelas.equals(_existingKelas)) {
          throw new IllegalStateException("Migration didn't properly handle kelas(com.linkajar.biodatasiswa.model.KelasModel).\n"
                  + " Expected:\n" + _infoKelas + "\n"
                  + " Found:\n" + _existingKelas);
        }
        final HashMap<String, TableInfo.Column> _columnsTbSiswa = new HashMap<String, TableInfo.Column>(8);
        ...
        _columnsTbSiswa.put("nomor_hp", new TableInfo.Column("nomor_hp", "TEXT", false, 0));
        ...
        if (! _infoTbSiswa.equals(_existingTbSiswa)) {
          throw new IllegalStateException("Migration didn't properly handle tb_siswa(com.linkajar.biodatasiswa.model.SiswaModel).\n"
                  + " Expected:\n" + _infoTbSiswa + "\n"
                  + " Found:\n" + _existingTbSiswa);
        }
      }
    }, "45d9ad07c85cac1beb9aebc815082ad3", "ee8e9164b0ec7d94aa6028cfea3ffdcb");
